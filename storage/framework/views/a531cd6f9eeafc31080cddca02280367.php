...
<ui-dropdown position="bottom start"  data-flux-dropdown>
    <?php $__blaze->ensureCompiled('Z:\project\project-javas\javas-coding-challenge\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/profile.blade.php', $__blaze->compiledPath.'/d4117d2ff5e7aebb1ee5c3191110477f.php'); ?>
<?php require_once $__blaze->compiledPath.'/d4117d2ff5e7aebb1ee5c3191110477f.php'; ?>
<?php $__blaze->pushData(['name' => auth()->user()->name,'initials' => auth()->user()->initials(),'icon:trailing' => 'chevrons-up-down','data-test' => 'sidebar-menu-button']); ?>
<?php _d4117d2ff5e7aebb1ee5c3191110477f($__blaze, ['name' => auth()->user()->name,'initials' => auth()->user()->initials(),'icon:trailing' => 'chevrons-up-down','data-test' => 'sidebar-menu-button'], [], ['name', 'initials'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
...
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
        ...
        <?php $__blaze->ensureCompiled('Z:\project\project-javas\javas-coding-challenge\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/separator.blade.php', $__blaze->compiledPath.'/72a74cb24650902c2fd94ebeff53d044.php'); ?>
<?php require_once $__blaze->compiledPath.'/72a74cb24650902c2fd94ebeff53d044.php'; ?>
<?php $__blaze->pushData([]); ?>
<?php _72a74cb24650902c2fd94ebeff53d044($__blaze, [], [], [], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
...
<?php /**PATH Z:\project\project-javas\javas-coding-challenge\resources\views/components/desktop-user-menu.blade.php ENDPATH**/ ?>