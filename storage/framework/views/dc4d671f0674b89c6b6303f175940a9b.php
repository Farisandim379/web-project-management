<?php
if (!function_exists('_dc4d671f0674b89c6b6303f175940a9b')):
function _dc4d671f0674b89c6b6303f175940a9b($__blaze, $__data = [], $__slots = [], $__bound = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrse589c380c124ceb1933f84bc7471c10c = ['position' => $tooltipPosition]; ?>
<?php $__blaze->pushData($__attrse589c380c124ceb1933f84bc7471c10c); ?>
<?php $slotse589c380c124ceb1933f84bc7471c10c = []; ?>
<?php ob_start(); ?>
    <?php $__blaze->ensureCompiled('Z:\project\project-javas\javas-coding-challenge\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-link.blade.php', $__blaze->compiledPath.'/13e8b10b18be3adf2f33252d64fe19a7.php'); ?>
<?php require_once $__blaze->compiledPath.'/13e8b10b18be3adf2f33252d64fe19a7.php'; ?>
<?php $__attrs13e8b10b18be3adf2f33252d64fe19a7 = ['attributes' => $attributes->class($classes),'data-flux-sidebar-item' => true]; ?>
<?php $__blaze->pushData($__attrs13e8b10b18be3adf2f33252d64fe19a7); ?>
<?php $slots13e8b10b18be3adf2f33252d64fe19a7 = []; ?>
<?php ob_start(); ?>
        <?php if ($icon): ?>
            <div class="relative">
...
<?php _3830ac24e188ac14005ba9cba02ce6e2($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => ''.$iconClasses.''], [], ['icon', 'variant'], isset($this) ? $this : null); ?>
...
<?php _3830ac24e188ac14005ba9cba02ce6e2($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => 'in-data-flux-sidebar-collapsed-desktop:not-in-data-flux-sidebar-group-dropdown:hidden size-4!'], [], ['icon', 'variant'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
        ...
        <?php if (isset($badge) && $badge !== ''): ?>
            ...
            <?php $__blaze->ensureCompiled('Z:\project\project-javas\javas-coding-challenge\vendor\livewire\flux\src/../stubs/resources/views/flux/navlist/badge.blade.php', $__blaze->compiledPath.'/d90c6e37f625e9f8bd9d75c2d910800c.php'); ?>
<?php require_once $__blaze->compiledPath.'/d90c6e37f625e9f8bd9d75c2d910800c.php'; ?>
<?php $__attrsd90c6e37f625e9f8bd9d75c2d910800c = ['attributes' => $badgeAttributes,'class' => 'in-data-flux-sidebar-collapsed-desktop:not-in-data-flux-sidebar-group-dropdown:hidden']; ?>
<?php $__blaze->pushData($__attrsd90c6e37f625e9f8bd9d75c2d910800c); ?>
<?php $slotsd90c6e37f625e9f8bd9d75c2d910800c = []; ?>
<?php ob_start(); ?><?php echo e($badge); ?><?php $slotsd90c6e37f625e9f8bd9d75c2d910800c['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($slotsd90c6e37f625e9f8bd9d75c2d910800c); ?>
<?php _d90c6e37f625e9f8bd9d75c2d910800c($__blaze, $__attrsd90c6e37f625e9f8bd9d75c2d910800c, $slotsd90c6e37f625e9f8bd9d75c2d910800c, ['attributes'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
        <?php endif; ?>
    <?php $slots13e8b10b18be3adf2f33252d64fe19a7['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($slots13e8b10b18be3adf2f33252d64fe19a7); ?>
<?php _13e8b10b18be3adf2f33252d64fe19a7($__blaze, $__attrs13e8b10b18be3adf2f33252d64fe19a7, $slots13e8b10b18be3adf2f33252d64fe19a7, ['attributes', 'data-flux-sidebar-item'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
...
<?php $__attrs8d8560881b07bdb88df45df81da83d34 = ['kbd' => $tooltipKbd,'class' => 'not-in-data-flux-sidebar-collapsed-desktop:hidden in-data-flux-sidebar-group-dropdown:hidden cursor-default']; ?>
<?php $__blaze->pushData($__attrs8d8560881b07bdb88df45df81da83d34); ?>
<?php $slots8d8560881b07bdb88df45df81da83d34 = []; ?>
<?php ob_start(); ?>
        <?php echo e($tooltip); ?>

    <?php $slots8d8560881b07bdb88df45df81da83d34['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
<?php _e589c380c124ceb1933f84bc7471c10c($__blaze, $__attrse589c380c124ceb1933f84bc7471c10c, $slotse589c380c124ceb1933f84bc7471c10c, ['position'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?><?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH Z:\project\project-javas\javas-coding-challenge\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/item.blade.php ENDPATH**/ ?>